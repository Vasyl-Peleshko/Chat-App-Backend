...
export const handleConnection = (socket: Socket, io: Server, connectedUsers: Record<string, string>) => {
...
export const handleDisconnection = (socket: Socket, io: Server, connectedUsers: Record<string, string>) => {
